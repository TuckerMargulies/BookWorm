	...
	<div class="row">
		<div class="col-8 col-content">
			<div class="tsd-panel tsd-typography">
				<h1 id="scandit-barcode-scanner-sdk-for-the-web">Scandit Barcode Scanner SDK for the Web</h1>
...
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/scandit-sdk"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
				...
				<p>A specific version of the library (example for 2.4.1) can also be included with:</p>
				<pre><code class="lang-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://unpkg.com/scandit-sdk@2.4.1"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-comment">&lt;!-- or --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/scandit-sdk@2.4.1"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
    ...
    <span class="hljs-keyword">return</span> <span class="hljs-built_in">string</span> + <span class="hljs-string">`<span class="hljs-subst">${Barcode.Symbology.toHumanizedName(barcode.symbology)}</span>: <span class="hljs-subst">${barcode.data}</span>\n`</span>;
				...
				<ul>
					<li><p>HTTPS deployment</p>
						<p>You must serve your final web application / website via HTTPS: due to browser security restrictions, camera access is only granted if that&#39;s the case. This is not needed for local IP addresses during development, however note that depending on the browser camera permissions could be asked every time in this case.</p>
					</li>
					...
					<li><p>Library performance</p>
						...
						<ul>
							...
							<li>Re-use <code>BarcodePicker</code> instances whenever possible by hiding and showing them instead of destroying and recreating them: each object needs to load and initialize the external library on creation. Ideally only one instance should be used.</li>
							<li>If possible, create a (hidden and paused) <code>BarcodePicker</code> in the background and simply resume scanning by switching its visibility to &quot;show&quot; when needed, instead of creating it on the fly to provide instant scanning capabilities. You can also set it up to not access the camera immediately and lazily do that later when needed, or also pause and resume camera access when necessary.</li>
