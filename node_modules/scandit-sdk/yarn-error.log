Arguments: 
  /Users/lw/emsdk-portable/node/8.9.1_64bit/bin/node /Users/lw/.yarn/bin/yarn.js release

PATH: 
  /Users/lw/emsdk-portable:/Users/lw/emsdk-portable/clang/e1.37.36_64bit:/Users/lw/emsdk-portable/node/8.9.1_64bit/bin:/Users/lw/emsdk-portable/emscripten/1.37.36:/Users/lw/.rvm/gems/ruby-2.3.3/bin:/Users/lw/.rvm/gems/ruby-2.3.3@global/bin:/Users/lw/.rvm/rubies/ruby-2.3.3/bin:/Users/lw/.yarn/bin:/Users/lw/.nvm/versions/node/v9.2.0/bin:/usr/local/bin:/usr/local/opt/coreutils/libexec/gnubin:/opt/local/bin:/opt/local/sbin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/MacGPG2/bin:/Applications/Wireshark.app/Contents/MacOS:/Users/lw/.rvm/bin:/Users/lw/.vimpkg/bin
...
npm manifest: 
  {
    ...
    "scripts": {
      ...
      "clean": "rm -rf build/main && rm -rf build/module && rm -rf build/browser && rm -rf test",
      "build": "yarn build:main && yarn build:module && rm -rf build/browser && yarn build:browser-umd && yarn build:browser-esm",
      "build:main": "rm -rf build/main && mkdir -p build/main/styles && \\cp -r src/styles/* build/main/styles && tsc -p tsconfig.json && yarn replace-version build/main/lib/workers/engineSDKWorker.js",
      "build:module": "rm -rf build/module && mkdir -p build/module/styles && \\cp -r src/styles/* build/module/styles && tsc -p config/exports/tsconfig.module.json && yarn replace-version build/module/lib/workers/engineSDKWorker.js",
      "build:browser-esm": "rollup -c config/exports/rollup.config.js -f es -o build/browser/index.esm.js && yarn prettier --write build/browser/index.esm.js && NODE_ENV=production rollup -c config/exports/rollup.config.js -f es -o build/browser/index.esm.min.js && yarn replace-version build/browser/index.esm.js build/browser/index.esm.min.js",
      "build:browser-umd": "rollup -c config/exports/rollup.config.js -f umd --name ScanditSDK -o build/browser/index.js && yarn prettier --write build/browser/index.js && NODE_ENV=production rollup -c config/exports/rollup.config.js -f umd --name ScanditSDK -o build/browser/index.min.js && yarn replace-version build/browser/index.js build/browser/index.min.js",
      "build:tests": "rm -rf test && node config/exports/build-tests.js",
      "build-engine-sdk": "./build-engine-sdk-wasm.sh && gulp build-engine-sdk && yarn copy-engine-sdk",
      "copy-engine-sdk": "\\cp src/engine-sdk-wasm/scandit-engine-sdk.min.js build && \\cp src/engine-sdk-wasm/scandit-engine-sdk.wasm build",
      "lint": "tslint --project . && stylelint --syntax scss src/**/*.scss",
      "unit": "yarn build && yarn build:tests && nyc ava",
      "unit-no-build": "yarn build:tests && nyc ava",
      "check-coverage": "nyc check-coverage --statements 33 --branches 33 --functions 33 --lines 33",
      "test": "yarn lint && yarn unit && yarn check-coverage",
      "watch": "yarn build:main && yarn build:tests && concurrently -r --kill-others \"npm run --silent build:main -- -w\" \"npm run --silent build:tests -- -w\" \"sleepms 4000 && ava --watch\"",
      "coverage": "yarn unit && yarn html-coverage && opn coverage/index.html",
      "html-coverage": "nyc report --reporter=html",
      "docs": "yarn docs:html && opn docs/index.html",
      "docs:html": "rm -rf docs && typedoc --name \"Scandit Barcode Scanner SDK for the Web\" src --excludePrivate --excludeProtected --exclude \"**/*.spec.ts\" --target es6 --mode file --theme typedoc-custom-theme --out docs && yarn copy-special-docs",
      "docs:json": "typedoc --name \"Scandit Barcode Scanner SDK for the Web\" --target es6 --mode file --json docs/typedoc.json src/index.ts",
      "license": "echo-cli Copyright © 2018 Scandit AG. All Rights Reserved.\\\\n\\\\nThe use of this software is governed by the Scandit Terms and Conditions.\\\\nhttps://ssl.scandit.com/terms/test.pdf\\\\n\\\\n > LICENSE && yarn licenses generate-disclaimer --production >> LICENSE && yarn copy-special-docs",
      "release": "yarn reset && yarn clean && yarn license && yarn test && yarn docs:html && yarn copy-engine-sdk && yarn standard-version",
      "copy-special-docs": "mkdir -p docs && md2html CHANGELOG.md > docs/CHANGELOG.html && mv -f docs/CHANGELOG.html docs/CHANGELOG.md && \\cp LICENSE docs/LICENSE",
      "replace-version": "replace \"%WASM_VERSION%\" \"$(node -p \"require('./package.json').version\")\"",
    ...
    "scripts-info": {
      ...
      "build": "(Remove and re)build the library",
      "build-engine-sdk": "Build the Scandit WebAssembly library in src/engine-sdk-wasm",
      "lint": "Lint all typescript source files",
      "unit": "(Remove and re)build the main library and run unit tests",
      "test": "Lint, build, test and check coverage of the library",
      "watch": "Watch source files, rebuild main library on changes, rerun relevant tests",
      ...
      "release": "*Specify release type with --release-as major|minor|patch* - Clean, build, test, generate docs, generate license, and prepare release"
    },
    "lint-staged": {
      "src/**/*.ts": [
        "prettier --write",
    ...
    "standard-version": {
      "scripts": {
        "prebump": "OLD_VERSION=$(node -p \"require('./package.json').version\")",
        "postbump": "yarn replace \"\\\"$OLD_VERSION\\\"\" \"\\\"$(node -p \"require('./package.json').version\")\\\"\" build/main/lib/workers/engineSDKWorker.js build/module/lib/workers/engineSDKWorker.js build/browser/*.js"
      },
      "skip": {
        "changelog": true
      }
    ...
    "ava": {
      ...
      "require": [
        "ignore-styles",
        "./src/test-helpers/setupBrowserEnv.js"
      ]
    },
    "devDependencies": {
      "@types/howler": "^2.0.5",
...
Lockfile: 
  ...
  commander@2.15.1, commander@^2.14.1:
    version "2.15.1"
  ...
  javascript-obfuscator@^0.16.0:
    version "0.16.0"
    resolved "https://registry.yarnpkg.com/javascript-obfuscator/-/javascript-obfuscator-0.16.0.tgz#34e75ebbd6c3f9cd32dbd98778935bf813f8616a"
    dependencies:
      "@babel/runtime" "7.0.0-beta.44"
      chalk "2.4.0"
      chance "1.0.13"
  ...
  rollup-plugin-sass@^0.6.1:
    version "0.6.1"
    resolved "https://registry.yarnpkg.com/rollup-plugin-sass/-/rollup-plugin-sass-0.6.1.tgz#f11e19800a0461d6119aeb01f65e60803af3b81d"
    dependencies:
  ...
  tslint-misc-rules@^3.3.3:
    version "3.3.3"
    resolved "https://registry.yarnpkg.com/tslint-misc-rules/-/tslint-misc-rules-3.3.3.tgz#fb1c4b33c6e0f21b9d5b25d8e87452d1e6488bec"
    dependencies:
      detect-newline "^2.1.0"
...
Trace: 
  ...
  Exit code: 1
  Command: sh
  Arguments: -c yarn reset && yarn clean && yarn license && yarn test && yarn docs:html && yarn copy-engine-sdk && yarn standard-version
  Directory: /Users/lw/projects/scandit-js
  Output:
  
      at ProcessTermError.MessageError (/Users/lw/.yarn/lib/cli.js:186:110)
      at new ProcessTermError (/Users/lw/.yarn/lib/cli.js:226:113)
      at ChildProcess.<anonymous> (/Users/lw/.yarn/lib/cli.js:30281:17)
